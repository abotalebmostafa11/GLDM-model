...
Time="days"
Implementation="Daily Infection covid 19 in Chelyabinsk  "
plot_title="Modelling and forecasting daily infection covid 19 by using BDLSTM Model"
Model_Name="bilstm"
# %%
